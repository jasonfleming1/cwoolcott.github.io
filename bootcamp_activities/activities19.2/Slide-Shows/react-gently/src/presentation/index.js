  ...
  render() {
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme} progress="bar">
        ...
        <Underline />
        <Heading style={{ marginTop: "15vh" }} size={4}></Heading>
        <Text style={{ fontSize: "25pt", marginTop: 15 }}>
        ...
        <Underline />
        <Heading style={{ marginTop: "15vh" }} size={4}>Scaffolding (reuse)</Heading>
        <Text style={{ fontSize: "25pt", marginTop: 15 }}>
             In order to avoid continuous NPM/Yarn installs, all of today's activity include only a src folder. You scaffold out a React app once with Create React App, and then swap out the src folder for each activity. It's recommended that you completely restart the dev server between activities.</Text>
        </Slide>
